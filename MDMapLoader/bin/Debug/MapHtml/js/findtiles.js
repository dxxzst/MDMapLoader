function downloadBaiduTiles(minZoom, maxZoom) {
    ...
    function convertor(point, ll2mc) {
        ...
        var y = ll2mc[2] + ll2mc[3] * a + ll2mc[4] * a * a + ll2mc[5] * a * a * a + ll2mc[6] * a * a * a * a + ll2mc[7] * a * a * a * a * a + ll2mc[8] * a * a * a * a * a * a;
    ...
    function findAllTiles(map,zoomLevel, callback) {
        ...
        var cP = [longitudeUnits, latitudeUnits, (center.lng - longitudeUnits * unitSize) / unitSize * tileSize, (center.lat - latitudeUnits * unitSize) / unitSize * tileSize];
        ...
        for (var i = 0,len = xydata.length; i < len; i++) {
            ...
            zoomLevel, "normal");
            var path = zoomLevel + "/" + xydata[i][0] + "/";
            var filename = xydata[i][1] + ".png"
        ...
        if (!!callback) {
            var jsonTiles = "";
            try {
                jsonTiles = JSON.stringify(tilesMap);
            } catch (e) {
                alert(e.message);
            }
